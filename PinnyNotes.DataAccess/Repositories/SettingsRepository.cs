...
public class SettingsRepository(string connectionString) : BaseRepository(connectionString)
{
    ...
    public static readonly string TableSchema = $@"
        (
            ...
            Editor_NoSelectionCopyAction        INTEGER DEFAULT 0,
    ...
    public SettingsDataModel GetById(int id)
    {
        ...
        return new SettingsDataModel()
        {
            ...
            OpaqueOpacity = reader.GetDouble(reader.GetOrdinal("Notes_OpaqueOpacity")),
            TransparentOpacity = reader.GetDouble(reader.GetOrdinal("Notes_TransparentOpacity")),
            ...
            StandardFontFamily = reader.GetString(reader.GetOrdinal("Editor_StandardFontFamily")),
            MonoFontFamily = reader.GetString(reader.GetOrdinal("Editor_MonoFontFamily")),
            ...
            TrimPastedText = GetBool(reader, "Editor_TrimPastedText"),
            TrimCopiedText = GetBool(reader, "Editor_TrimCopiedText"),
            CopyTextOnHighlight = GetBool(reader, "Editor_CopyTextOnHighlight"),
            NoSelectionCopyAction = GetEnum<CopyFallbackActions>(reader, "Editor_NoSelectionCopyAction"),
        ...
        ExecuteNonQuery(
            ...
            @"
                ...
                SET
                    ...
                    Editor_NoSelectionCopyAction = @editor_NoSelectionCopyAction,
            ...
            parameters: [
                ...
                new("@editor_TrimPastedText", settings.TrimPastedText),
                new("@editor_TrimCopiedText", settings.TrimCopiedText),
                new("@editor_CopyTextOnHighlight", settings.CopyTextOnHighlight),
                new("@editor_NoSelectionCopyAction", settings.NoSelectionCopyAction),
